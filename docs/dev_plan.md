...
- **增量核对（2026-08-23）**：赛事公告公开附件明确源码 ZIP 上限 200 MB、说明书 300 页、视频 5 分钟/200 MB，截止 2026-09-01 23:59。当前 Git 跟踪文件约 273 MB，其中随包标题型 BM25 语料约 92 MB；P2-02 的“最终提交包不超限”仍未完成，需在不破坏队友离线 smoke 的前提下决定公开轻量语料与外部数据分发方式，并以实际 ZIP 大小验收。
