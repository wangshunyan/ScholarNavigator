...
param(
    ...
    [ValidateSet("local", "hybrid", "hybrid_deep_rrf", "network_hybrid", "rules", "dense", "reranker", "dense_reranker_soft", "dense_reranker_rrf_soft", "dense_reranker_quality", "dense_reranker_llm", "dense_reranker_llm_feedback")]
...
if ($Configuration -in @("dense_reranker_soft", "dense_reranker_rrf_soft")) {
    $arguments += @(
        "--judgement-config",
...
if ($Configuration -in @("reranker", "dense_reranker_soft", "dense_reranker_rrf_soft", "dense_reranker_quality", "dense_reranker_llm", "dense_reranker_llm_feedback")) {
    $arguments += @(
