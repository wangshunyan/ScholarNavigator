...
from scholar_agent.evaluation.corpus_metadata_audit import REQUIRED_FIELDS, audit_jsonl_corpus
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="fail unless every valid row contains each listed metadata field",
    )
    ...
    report = audit_jsonl_corpus(
        ...
        required_fields=tuple(args.require_fields or ()),
    )
