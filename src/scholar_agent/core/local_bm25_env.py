...
LOCAL_BM25_AUTHORS_FIELD_ENV = "SCHOLAR_AGENT_LOCAL_BM25_AUTHORS_FIELD"
LOCAL_BM25_YEAR_FIELD_ENV = "SCHOLAR_AGENT_LOCAL_BM25_YEAR_FIELD"
LOCAL_BM25_VENUE_FIELD_ENV = "SCHOLAR_AGENT_LOCAL_BM25_VENUE_FIELD"
...
def local_bm25_config_from_env(
    ...
    fields = LocalBM25FieldConfig(
        ...
        authors=_env_or_default(LOCAL_BM25_AUTHORS_FIELD_ENV, "authors"),
        year=_env_or_default(LOCAL_BM25_YEAR_FIELD_ENV, "year"),
        venue=_env_or_default(LOCAL_BM25_VENUE_FIELD_ENV, "venue"),
